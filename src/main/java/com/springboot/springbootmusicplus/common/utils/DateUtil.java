...
public class DateUtil {
    ...
    /**
     * 将 date 转化为 yyyy-MM-dd HH:mm:ss 格式
     * @param date
     * @return
     */
     ...
     * @return
     */
    public Date getMonthCycleOfDate(Date date, int i) {
        Calendar cd = Calendar.getInstance();
        cd.setTime(date);
     ...
     * @return 年数
     */
    public int getYearByMinusDate(Date fromDate, Date toDate) {
     ...
     * @return 月数
     */
    public int getMonthByMinusDate(Date fromDate, Date toDate) {
        Calendar df = Calendar.getInstance();
        df.setTime(fromDate);
     ...
     * @return
     */
    public int calcAge(Date birthday, Date calcDate) {
     ...
     * @return
     */
    public String getBirthDayFromIDCard(String idno) {
        Calendar cd = Calendar.getInstance();
        if (idno.length() == 15) {
            ...
            cd.set(Calendar.DAY_OF_MONTH,
                    Integer.parseInt(idno.substring(10, 12)));
            ...
            cd.set(Calendar.DAY_OF_MONTH,
                    Integer.parseInt(idno.substring(12, 14)));
        }
     ...
     */
    public Date addYear(Date date, int iYear) {
        Calendar cd = Calendar.getInstance();
    ...
    public long getAgeByBirthday(String date) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(convertStringByDate(new Date()));
